    ...
    def downloadVideo(link):
        ...
        try:
            ...
            try:
                ...
                print("Extracted Video ID:", video_id)  # Debugging: Print the video ID
            except IndexError:
            ...
            try:
                ...
                print("Extracted Target Video Audio ID:", target_video_audio_id)  # Debugging: Print the target video audio ID
            except IndexError:
